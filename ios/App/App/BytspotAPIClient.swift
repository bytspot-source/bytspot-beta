...
struct NativeProfileDataAPI {
    ...
    static let fixtureProfile = NativeUserProfileRecord(id: "native-fixture-user", email: "member@example.com", name: "Avery Brooks", phone: "+1 404 555 0198", profileImage: nil, address: "Atlanta, GA", birthday: "1994-04-03")
