...
enum NativeDiscoverCardControl {
    ...
    /// Partner placement is a discovery relationship, not fulfillment control.
    static let partnerProfileCardIDs: Set<String> = ["broni-home-taste"]

    static func isControlled(cardID: String) -> Bool { controlledCardIDs.contains(cardID) }
    static func isPartnerProfile(cardID: String) -> Bool { partnerProfileCardIDs.contains(cardID) }
