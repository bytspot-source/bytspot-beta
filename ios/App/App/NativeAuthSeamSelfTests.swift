...
enum NativeAuthSplashSelfTests {
    ...
    private static func assertAuthRouteContractsAreNativeOnly() {
        ...
        precondition(NativeReviewAuthFallback.isEnabled(mockRaw: nil, nativeRootEnabled: true), "NativeAuthSplashSelfTests: review auth fallback must be available for native-root review walkthroughs.")
