...
final class NativeAuthLaunchInputTests: XCTestCase {
    ...
    func testLaunchRecommendationsRequireTrustworthyLiveVenueProvenance() {
        ...
        let mixedFallback = NativeTabContentSnapshot(venues: NativeTabContentSnapshot.fallback.venues, discoverCards: [providerCard], events: [], source: .mixed, lastUpdated: Date(), errorMessage: nil)
        ...
        let trustedLive = NativeTabContentSnapshot(venues: [liveVenue], discoverCards: [], events: [], source: .live, lastUpdated: Date(), errorMessage: nil, hasLiveVenueInventory: true)
        ...
        XCTAssertTrue(NativeHomeRegionPresentation.venueSafeSnapshot(mixedFallback).venues.isEmpty)
