...
final class BytspotTrustEngineTests: XCTestCase {
    ...
    func testAppleMapsHandoffBuildsDrivingDirectionsAndFailsClosedWithoutCoordinates() {
        ...
        let valid = NativeVenueSummary(id: "route-cafe", name: "Route Cafe", category: "coffee", address: "1 Route St", distance: "0.3 mi", rating: 4.8, latitude: 33.7870, longitude: -84.3830, crowd: nil, parking: NativeParkingSummary(totalAvailable: 0, priceLabel: "—"), verifiedPatchId: nil, imageUrl: nil)
        let origin = NativeVenueSummary(id: "no-coords", name: "Unknown Spot", category: "event", address: "TBA", distance: "—", rating: nil, latitude: 0, longitude: 0, crowd: nil, parking: NativeParkingSummary(totalAvailable: 0, priceLabel: "—"), verifiedPatchId: nil, imageUrl: nil)
        XCTAssertEqual(NativeAppleMapsHandoff.disposition(for: valid), .openAppleMaps)
        XCTAssertEqual(NativeAppleMapsHandoff.disposition(for: origin), .failClosed)
