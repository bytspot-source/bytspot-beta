...
const checks = [
  ...
  ['Main App associated domains are webview applinks', appEntitlements.includes('applinks:bytspot.com') && appEntitlements.includes('applinks:beta.bytspot.com') && !appEntitlements.includes('appclips:') && !appEntitlements.includes('applinks:bytspot.app')],
  ...
  ['Main App native patch surface is opt-in only', appDelegate.includes('shouldPresentNativePatchExperience') && appDelegate.includes('isCapacitorWebHost') && appDelegate.includes('components.scheme?.lowercased() == "bytspot"')],
