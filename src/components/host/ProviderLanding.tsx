...
export function ProviderLanding({ isDarkMode, onGetStarted, onBackToMain }: ProviderLandingProps) {
  const springConfig = {
  ...
  // First card open by default — hooks providers on the income question immediately
  ...
  const benefits = [
    {
      ...
      description: 'Your space earns money around the clock — even when you\'re not there. Providers typically recoup setup costs within the first two weeks and see consistent income month after month. The more prime your location, the higher your earning potential.',
    ...
    },
    {
      ...
      description: 'Bytspot\'s pricing engine monitors local demand, events, and competitor rates in real time — automatically adjusting your price to maximize revenue. Providers who use dynamic pricing earn up to 40% more than those with fixed rates.',
      gradient: 'from-orange-500 to-red-500',
    },
    {
      icon: Users,
      title: 'Verified Valet Drivers and Providers Only',
      teaser: '500+ providers in Atlanta',
      description: 'Every valet driver and provider on Bytspot goes through ID verification and a background check before they can book. You\'re not opening your space to strangers — you\'re welcoming vetted members of a trusted local community.',
    ...
    },
    {
      ...
      description: 'Your Provider dashboard gives you a real-time view of bookings, occupancy rates, and earnings trends. Spot your busiest hours, track monthly growth, and export reports — all from one clean mobile interface.',
    ...
    <div className="min-h-screen overflow-y-auto pb-24">
      ...
      <div className="px-8 mb-8">
        ...
        <div className="space-y-3">
          {[
            { step: '1', title: 'Sign Up', description: 'Create your Provider account in minutes' },
