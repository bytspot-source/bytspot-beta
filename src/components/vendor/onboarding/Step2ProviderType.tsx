...
export function Step2ProviderType({ onComplete, initialValue }: Step2ProviderTypeProps) {
  const [selectedType, setSelectedType] = useState<ProviderType | undefined>(initialValue);
  ...
  const handleContinue = () => {
    if (selectedType) {
      onComplete({ providerType: selectedType, hostType: selectedType });
    }
  };
