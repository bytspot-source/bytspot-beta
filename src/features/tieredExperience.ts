...
export const TIERED_EXPERIENCE_PROFILES: Record<ConsumerExperienceTier, ConsumerTierProfile> = {
  explorer: {
    ...
    name: 'Member',
    eyebrow: '',
    heroLabel: 'Easy starts nearby',
    priorityRailLabel: 'Worth a look nearby',
    cardStyleLabel: '',
    accessLevel: 'Arrival benefits unlock as you move through the city',
    patchVerifiedLabel: 'Patch Verified',
    benefits: ['Easy arrival discovery', 'Clear pricing before you go', 'Same-day options when available'],
    accentClass: 'from-cyan-500/22 via-slate-500/14 to-blue-500/18 border-cyan-300/25',
  },
  insider: {
    tier: 'insider',
    name: 'Bytspot Insider',
    eyebrow: '',
    heroLabel: 'Shaped around your night',
    priorityRailLabel: 'Chosen for you',
    cardStyleLabel: '',
    accessLevel: 'Better arrivals, smarter timing, and more comfortable options',
    patchVerifiedLabel: 'Patch Verified',
    benefits: ['Smarter arrival recommendations', 'Occasional early access', 'Benefits that improve with each booking'],
  ...
  vip: {
    ...
    name: 'Bytspot Black',
    eyebrow: '',
    heroLabel: 'Priority arrivals and rare access',
    priorityRailLabel: 'Held for you',
    cardStyleLabel: '',
    accessLevel: 'Priority booking, calmer arrivals, and dedicated valet windows',
    patchVerifiedLabel: 'Patch Verified',
    benefits: ['Priority arrival booking', 'Dedicated support', 'Curated arrivals', 'Valet credits', 'Passport wristband'],
...
export function getConsumerTierProgress(input: TierProgressInput): ConsumerTierProgress {
  ...
  return {
    ...
    bookingsNeeded,
    progressPercent,
    label: nextTier ? `${bookingsNeeded} more booking${bookingsNeeded === 1 ? '' : 's'} to unlock the next perk` : 'Your benefits are already in motion',
  };
}
...
export function getTieredHomeCards(tier: ConsumerExperienceTier): TieredHomeCard[] {
  ...
  return [
    {
      id: 'hero-chef-dinner',
      title: 'A private chef dinner, handled at home',
      subtitle: 'Chef Maria · 4.98 ★ · intimate, arrival-ready service',
    ...
    {
      id: 'premium-valet',
      title: 'Valet pickup without the scramble',
    ...
    {
      id: 'cottage-massage',
      title: 'At-home wellness, quietly arranged',
      subtitle: 'Massage, chef, wellness · vetted local providers',
